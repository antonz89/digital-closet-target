...
apiButton.addEventListener('click', async (e) => {
  ...
  let url = `https://api.redcircleapi.com/request?api_key=11C67C7D0403466BA1E2ED86329FC64A&type=search&search_term=${searchItem.value}${searchColor.value}&sort_by=best_seller`;
